...
class TestApplyHumanValidationLabels:
    ...
    def test_does_not_overwrite_per_source_columns(self) -> None:
        """Colunas de cada fonte de rotulagem devem permanecer intactas."""
        consensus = pl.DataFrame(
            {
                "id": ["1"],
                "sentiment_label": ["positivo"],
        ...
        assert result["sentiment_label_openai"].to_list() == ["neutro"]
